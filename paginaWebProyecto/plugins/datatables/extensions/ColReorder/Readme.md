...
ColReorder adds the ability for the end empresas to click and drag column headers to reorder a table as they see fit, to DataTables. Key features include:
