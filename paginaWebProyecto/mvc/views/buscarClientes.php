...
?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <p>
                      Use las siguientes opciones para realizar la búsqueda de un cliente. Recuerde que en este formulario hay campos obligatorios(*).<br><br>
                    </p>
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="criterio" id="criterio" required tabindex="1" autofocus>
                          <option value="IdCliente" selected>Número de identificación del cliente (NIT, CC)</option>
                        <option value="RazonSocial" >Razón Social del cliente</option>
                          <option value="Lugar">Ubicación del cliente</option>
                      </select>
                    </div>
                    ...
                    <span class="input-group-btn">
                      <button class="btn btn-info btn-flat" type="submit" tabindex="4">Buscar cliente</button>
                    </span>
                      </div><!-- /input-group -->
                  ...
                  <?php
                  if(isset($_GET['encontrados'])&&isset($_GET['busqueda'])) {
                  ?>

                  <div class="callout callout-warning">
                      <h4>Consulta sin coincidencias</h4>
                          ...
                          <div class="box box-warning">
                              ...
                              <div class="box-body">
                                  ...
                                  <table id="example1" class="table table-bordered table-striped">
                                      ...
                                      <tr>
                                          <td>
                                              <?php echo $respuesta['IdCliente']; ?>
                                          </td>
                                          <td>
                                              <?php echo $respuesta['RazonSocial']; ?>
                                          </td>
                                          <td>
                                              <?php echo $respuesta['TelFijo']; ?>
                                          </td>
                                          <td>
                                              <?php echo $respuesta['Nombre']; ?>
                                          </td>
                                          <td>
                                              <a href="nuevoCliente.php?id=<?php echo $respuesta['IdCliente']; ?>">
                                                  <i class="fa fa-fw fa-search-plus"></i>
                                              </a>
                                              <a href="nuevoCliente.php?id=<?php echo $respuesta['IdCliente']; ?>">
                                                  <i class="fa fa-fw fa-edit"></i>
                                              </a>
                                              <a href="../controllers/ClientesController.php?id=<?php echo $respuesta['IdCliente'];
                                              echo '&controlar=eliminar'; ?>" onclick="return confirmar();">
                  ...
                  <div class="box">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td>
                          <?php echo $cliente['TelFijo']; ?>
                        </td>
                        <td>
                            <?php echo $cliente['nombre']; ?>
                        </td>
                        <td>
                            <a href="nuevoCliente.php?id=<?php echo $cliente['IdCliente']; ?>">
                                <i class="fa fa-fw fa-search-plus"></i>
                            </a>
                            <a href="nuevoCliente.php?id=<?php echo $cliente['IdCliente']; ?>" >
                                <i class="fa fa-fw fa-edit"></i>
                            </a>
                          <a href="../controllers/ClientesController.php?id=<?php echo $cliente['IdCliente'];  echo '&controlar=eliminar'; ?>" onclick="return confirmar();">
                            <i class="fa fa-fw fa-trash-o"></i>
                          </a>
                        </td>
  <?php
  ...
  ?>
                  ...
                  if (!isset($_GET['todos'])){ ?>
                      ...
                      <div class="box">
                          <div class="box-header with-border">
                              <h3 class="box-title">Ver todos los clientes registrados</h3>
                          </div><!-- /.box-header -->
                          <div class="box-body">
                              <p>
                          ...
                          <div class="box-footer">
                              <form action="buscarClientes.php?todos=1">
                                  <button type="submit" class="btn btn-success pull-right" tabindex="14"
                                          value="todos" name="todos" id="todos">Ver todos
                                  </button>
                              </form>
                          </div>
                      </div>
      ...
      <script>
          function confirmar() {
              if (confirm('¿Está seguro que desea eliminar por completo este registro?')) {
                  return true;
              } else {
                  return false;
              }
