        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../../../forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="box box-default">
                              ...
                              <!-- /.box-header -->
                              <div class="box-body">
                                  <form role="form" action="../controllers/ClientesController.php?id=<?php echo $idClienteOld;?>&controlar=modificar"
                                        method="post">
                                      <!-- text input -->
                          ...
                          <div class="box box-default">
                              ...
                              <div class="box-body">
                                  ...
                                  <div class="form-group">
                                      <label for="IdCliente">Identificación del cliente (NIT, CC)*</label>
                                  ...
                                  <div class="form-group">
                                      <label for="TelFijo">Teléfono principal*</label>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select class="form-control select2" name="Lugar" id="Lugar" required tabindex="6">
                                          <?php
                                          require_once '../models/CiudadesDao.php';
                                          require_once '../utilities/Conexion.php';
                                          $ciudadesDao = new CiudadesDao();
                                          $todasCiudades = $ciudadesDao->listarTodas();
                                          foreach($todasCiudades as $ciudad){
                                              ?>
                                              <option value="<?php echo $ciudad['IdCiudad']?>"
                                              <?php if($cliente['IdCiudad']==$ciudad['IdCiudad']) {
                                                  echo('selected');
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select class="form-control select2" name="TipoCliente" id="TipoCliente" required tabindex="7">
                                          ...
                                          foreach($todosTiposCliente as $tipo){
                                              ...
                                              <option value="<?php echo $tipo['IdTipo'] ?>"
                                                  <?php if($cliente['IdTipo']==$tipo['IdTipo']) {
                                  ...
                                  <div class="form-group">
                                      <label for="ActividadCliente">Actividad del cliente*</label>
                                      <select class="form-control select2" name="ActividadCliente" id="ActividadCliente" required
                                              tabindex="8">
                                          ...
                                          foreach($todasActividadesCliente as $actividad){
                                              ...
                                              <option value="<?php echo $actividad['IdActividad'] ?>"
                                                  <?php if($cliente['IdActividad']==$actividad['IdActividad']) {
                                                      echo('selected');
                                                  }?>
                                                  ><?php echo $actividad['Nombre'] ?></option>
                                              <?php
                                          }
                                          ?>
                                      </select>
                                  ...
                                  <div class="form-group">
                                      <label for="Clasificacion">Clasificación del cliente*(Sólo Coordinador)</label>
                                      <select class="form-control select2" name="Clasificacion" id="Clasificacion" required
                                              tabindex="9">

                                          <?php
                                          require_once '../models/ClasificacionesClienteDao.php';
                                          require_once '../utilities/Conexion.php';
                                          $clasificacionesCliente = new ClasificacionesClienteDao();
                                          $todasClasificacionesCliente = $clasificacionesCliente->listarTodas();
                                          foreach($todasClasificacionesCliente as $clasificacion){
                                              ?>
                                              <option value="<?php echo $clasificacion['IdClasificacion'] ?>"
                                                  <?php if($cliente['IdClasificacion']==$clasificacion['IdClasificacion']) {
                                                      echo('selected');
                                                  }?>
                          ...
                          <div class="box box-default">
                              ...
                              <div class="box-body">
                                  ...
                                  <div class="form-group">
                                      <label for="NombresContacto">Nombres contacto*</label>
                                      <input type="text" name="NombresContacto" id="NombresContacto" class="form-control"
                                             value="<?php echo $cliente['NombresContacto'];?>"
                                             required tabindex="10"/>
                                  </div>
                                  <div class="form-group">
                                      <label for="ApellidosContacto">Apellidos contacto*</label>
                                      <input type="text" name="ApellidosContacto" id="ApellidosContacto" class="form-control"
                                             value="<?php echo $cliente['ApellidosContacto'];?>"
                                             required tabindex="11"/>
                                  </div>
                                  <div class="form-group">
                                      <label for="CelularContacto">Celular contacto*</label>
                                      <input type="number" name="CelularContacto" id="CelularContacto" class="form-control"
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="box box-default">
                              ...
                              <!-- /.box-header -->
                              <div class="box-body">
                                  <form role="form" action="../controllers/ClientesController.php?controlar=crear"
                                        method="post">
                                      <!-- text input -->
                                      <div class="form-group">
                                          <p>
                          ...
                          <div class="box box-default">
                              ...
                              <div class="box-body">
                                  ...
                                  <div class="form-group">
                                      <label for="RazonSocial">Razón social*</label>
                                      <input type="text" name="RazonSocial" id="RazonSocial" class="form-control" placeholder="Mi empresa"
                                             required tabindex="2"/>
                                  </div>
                                  <div class="form-group">
                                      <label for="Direccion">Dirección principal*</label>
                                  ...
                                  <div class="form-group">
                                      <label for="TelFijo">Teléfono principal*</label>
                                      <input type="number" name="TelFijo" id="TelFijo" class="form-control" placeholder="634342"
                                             required tabindex="4"/>
                                  </div>
                                  <div class="form-group">
                                      <label for="Email">Email principal*</label>
                                  ...
                                  <div class="form-group">
                                      <label for="Clasificacion">Clasificación del cliente (Automática)</label>
                                      <input type="text" class="form-control" value="Nuevo"  id="Clasificacion" readonly/>
                                      <input type="hidden" name="Clasificacion" id="Clasificacion" class="form-control" value="1"
                                             placeholder="Nuevo"/>
                          ...
                          <div class="box box-default">
                              ...
                              <div class="box-body">
                                  ...
                                  <div class="form-group">
                                      <label for="NombresContacto">Nombres contacto*</label>
                                      <input type="text" name="NombresContacto" id="NombresContacto" class="form-control" placeholder="Pedro"
                                                required tabindex="10"/>
                                  </div>
                                  <div class="form-group">
                                      <label for="ApellidosContacto">Apellidos contacto*</label>
