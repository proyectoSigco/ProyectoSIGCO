    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-building"></i> <span>Empresas</span> <i
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-archive"></i> <span>Productos</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-shopping-cart"></i> <span>Cotizaciones</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#">Registrar</a></li>
                        <li><a href="#">Buscar</a></li>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-money"></i> <span>Ordenes de compra</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#">Registrar</a></li>
                        <li><a href="#">Buscar</a></li>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-users"></i> <span>Capacitaciones</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#">Registrar</a></li>
                        <li><a href="#">Buscar</a></li>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-book"></i> <span>Asesorias</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#">Registrar</a></li>
                        <li><a href="#">Buscar</a></li>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-bar-chart"></i> <span>Panel</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="#">Registrar</a></li>
                        <li><a href="#">Buscar</a></li>
                            ...
                            foreach ($Productos as $iterator) { ?>
                                <tr>
                                    ...
                                    <div class="span8">
                                        ...
                                        <ul class="thumbnails col-md-6" style="list-style-type: none">
                                            <li class="span4">
                                                <div class="thumbnail">
                                                    <span class="badge badge-inverse pull-right price">$<?php echo $iterator['ValorBase'] ?></span>
                                                    <?php if (strpos($iterator['rutaImagen'],'../') !== false) {?>
                                                    <img src="<?php echo $iterator['rutaImagen'] ?>"
                                                             alt="Unicorn Flux" >
                                                    <?php } else{?>
                                                    <img src="../images/55e3831d3869aPlaceholder.png"
                                                         alt="Unicorn Flux" >
                                                    <?php } ?>
                                                    <h3 class="clearfix">
                                                      <span class="pull-left">
                                                        <?php echo $iterator['Nombre'] ?>
                                                          <small><?php echo $iterator['UnidadMedida'] ?></small>
                                                      </span>


                                                    </h3>
                                                    <p>
                                                        <?php echo $iterator['Descripcion'] ?>
                                                    </p>
