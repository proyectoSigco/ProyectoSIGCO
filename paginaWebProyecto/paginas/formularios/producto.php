                ...
                <form class="form-horizontal" id="defaultForm" action="../../php/Controladores/ControladorProducto.php" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <!-- InicioInput poner class="form-control"-->
                              <select class="form-control" name="presentacionProducto" id="presentacionProducto" type="text" required title="Este campo es requerido" >
                                  <option value="1111">Galon</option>
                                  <option value="1112">Tambor</option>
                                  <option value="1113">frasco</option>
                              </select>
                            <!-- FinInput -->
                          </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                            <!-- InicioInput poner class="form-control"-->
                              <select class="form-control" name="categoriaProducto" id="categoriaProducto"  required title="Este campo es requerido">
                                  <option value="2221">Desengrasantes</option>
                                  <option value="2222">Analisis Agua</option>
                                  <option value="2223">Industrial</option>
                              </select>
